...
const SignIn = () => {
  ...
  return (
    <div className='grid lg:grid-cols-2'>
      {/* first column */}
      <div className=' bg-[url(C:\Users\singh\Desktop\Infinikul\infi\src\assets\Login.jpg)] lg:h-[1120px] h-[500px] bg-cover rounded-3xl text-white flex justify-center items-center shadow-2xl'>
