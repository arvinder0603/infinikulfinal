          ...
          <nav className="flex w-full px-4 justify-between gap-2 items-center">
            <div className="flex justify-between w-full items-center pr-2">
              ...
              <div className="flex flex-row justify-center items-center gap-4">
                <NavLink to="/signin" className="uppercase bg-transparent border-4 border-white font-bold lg:text-xl md:text-lg text-base text-center text-white px-5 py-1 rounded-[12px] shadow-md hover:shadow-xl transition-all duration-300 ease-in-out">
                  login
                </NavLink>
          ...
          >
            ...
            <div>
              <div className="flex flex-col justify-center items-center gap-4">
                <NavLink  to="/signin" className="uppercase bg-transparent border-4 border-[#6721EF] font-bold lg:text-xl md:text-lg text-base text-center text-[#6721EF] w-[100%] px-5 py-1 rounded-[12px] shadow-md hover:shadow-xl transition-all duration-300 ease-in-out">
                  login
                </NavLink>
            ...
            <div className="flex flex-col items-center justify-center lg:gap-12 md:gap-10 gap-8">
              <div className="flex flex-col justify-center items-center text-center text-white md:w-auto w-[90%] mx-auto gap-4">
                <div className="flex flex-col justify-center items-center text-center gap-3">
                  <h1 className="lg:text-[70px] md:text-4xl text-3xl font-bold leading-10">
                    unlock your potential with
                  </h1>
                  <h1 className="lg:text-[70px] md:text-4xl text-3xl font-bold leading-10 mt-3">
                    our community.
                  </h1>
                </div>
                <p className="lg:text-2xl mt-6 md:text-lg text-base font-semibold">
                  connect, learn, archieve, and earn with our community.
                </p>
              </div>
              <div className="flex flex-col justify-center items-center w-full">
                <NavLink to="signup" className="uppercase text-[#6921EF] font-bold lg:text-2xl md:text-xl text-lg text-center bg-white px-7 py-3 rounded-[12px] shadow-md hover:shadow-xl transition-all duration-300 ease-in-out ">
                  join us
                </NavLink>
              </div>
            </div>
